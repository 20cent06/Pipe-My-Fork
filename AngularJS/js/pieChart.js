...
function pieChart() {
  ...
  var pullOutLabelFont = "bold 16px Verdana, sans-serif";  // Pull-out slice label font
  var pullOutValueFont = "bold 12px Verdana, sans-serif";  // Pull-out slice value font
